...
# print(somethingLikeNumber + 1) # TypeError: can only concatenate str (not "int") to str

print(int(somethingLikeNumber) + 1)
print(somethingLikeNumber + str(1)) # nie dodawanie a laczenie Stringow

print(type(somethingLikeNumber)) # type() odpowie z jakim typem mamy do czynienia
print(type(int(somethingLikeNumber) + 1))

# zadania
# Uwaga! Skopiowany tekst jest długi i zawiera znaki ENTER. 
# Jeśli chcesz przypisać do zmiennej taki tekst możesz użyć konstrukcji z trzema apostrofami
